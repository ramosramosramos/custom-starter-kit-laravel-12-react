...
<body class="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-6">
    <div class="text-center">
        <h1 class="text-9xl font-extrabold text-red-600 tracking-widest">402</h1>
        <p class="text-2xl md:text-3xl font-semibold mt-6 text-gray-800">
            Payment Required
        </p>
<p class="mt-4 text-gray-500">
    Oops! It looks like this feature isn’t available on your current plan.
    Please make a payment or upgrade to unlock it.
</p>
